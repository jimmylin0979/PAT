"""
Reference from https://github.com/xiaohu2015/detectron2_ema
"""
...
class EMAHook(HookBase):
    def __init__(self, cfg, model):
        ...
        self.ema_updater = EMAUpdater(self.model.ema_state, decay=cfg.MODEL_EMA.DECAY, device=self.device)
